...
export async function POST(req: NextRequest) {
  ...
  const systemPrompt = `You are a friendly, encouraging sushi instructor. You are teaching a student about "${skillName}" (topic: ${topic}, difficulty: ${difficulty}).
...
- Give specific, practical tips they can use immediately
