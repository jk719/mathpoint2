...
export const demoQuestions: SATQuestion[] = [
  ...
  { id: 'pq-mc3', skillId: 'pct-multi-convert-hard', questionText: 'Which is greater: $\\frac{5}{7}$ or 72%?', choices: [{ label: 'A', text: '$\\frac{5}{7}$ is greater' }, { label: 'B', text: '72% is greater' }, { label: 'C', text: 'They are equal' }, { label: 'D', text: 'Cannot be determined' }], correctAnswer: 'A' },
  ...
  { id: 'pq-cd2', skillId: 'pct-compound-discount-hard', questionText: 'A $500 TV: 30% off + 7% tax. Competitor: $380 + 7% tax. Which is cheaper and by how much?', choices: [{ label: 'A', text: 'First store, by $31.50' }, { label: 'B', text: 'Second store, by $33.15' }, { label: 'C', text: 'Second store, by $31.50' }, { label: 'D', text: 'Same price' }], correctAnswer: 'C' },
